...
This is an app for using react in a rails applications with webpack
...
The app help you use react in a rails application
...
```sh
  cd my-folder
  git clone https://github.com/Daniel-Kigozi/hello-rail-react.git
```
...
Feel free to check the [issues page](https://github.com/Daniel-Kigozi/hello-rail-react/issues).
